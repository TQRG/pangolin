...
public class PangolinFrame extends JFrame {
	...
	protected void endedDissociatedTransaction() {
		...
		Collector.instance().endTransaction("Dissociated " + Integer.toString(this.dissociatedTransactions), true);
		updateInformation();
	}
	...
	protected void endedAssociatedTransaction() {
		...
		Collector.instance().endTransaction("Associated " + Integer.toString(this.associatedTransactions), false);
		updateInformation();
	}
